...
void led_music_disco(uint16_t led, soundToneType pitch)
{
	led_ON(led);
	CS43L22_Beep(pitch, 300);
	led_OFF(led);
}

void play()
{
	led_music_disco(GPIO_PIN_12, C5);
	led_music_disco(GPIO_PIN_12, C5);
	led_music_disco(GPIO_PIN_13, D5);
	led_music_disco(GPIO_PIN_12, C5);
	led_music_disco(GPIO_PIN_14, F5);
	led_music_disco(GPIO_PIN_15, E5);
	HAL_Delay(500);
	...
	led_music_disco(GPIO_PIN_13, D5);
	led_music_disco(GPIO_PIN_12, C5);
	led_music_disco(GPIO_PIN_14, G5);
	led_music_disco(GPIO_PIN_15, F5);
	HAL_Delay(500);

	led_music_disco(GPIO_PIN_12, C5);
	led_music_disco(GPIO_PIN_12, C5);
	led_music_disco(GPIO_PIN_13, C6);
	led_music_disco(GPIO_PIN_14, A5);
	led_music_disco(GPIO_PIN_15, F5);
	led_music_disco(GPIO_PIN_12, E5);
	led_music_disco(GPIO_PIN_13, D5);
	HAL_Delay(500);

	led_music_disco(GPIO_PIN_12, B5);
	led_music_disco(GPIO_PIN_12, B5);
	led_music_disco(GPIO_PIN_13, A5);
	led_music_disco(GPIO_PIN_14, F5);
	led_music_disco(GPIO_PIN_15, G5);
	led_music_disco(GPIO_PIN_14, F5);
}
